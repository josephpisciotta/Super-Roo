...
#pragma mark - InstructionsLayer

// InstructionsLayer implementation
@implementation InstructionsLayer

// Helper class method that creates a Scene with the InstructionsLayer as the only child.
+(CCScene *) scene
{
...
-(id) init
{
	...
	if( (self=[super init]) ) {
		...
		CCLabelTTF *label = [CCLabelTTF labelWithString:@"Instructions" fontName:@"Australian Sunset" fontSize:60];
